...
//hiển thịthông báo phần newsletter
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-6 col-12">
							...
							<div class="single-widget twitter">
								...
								<a target="_blank" href="<?php echo getOption('general_twitter'); ?>" class="twitter-follow-button" data-show-count="false"><i class="fa fa-twitter"></i> Follow @ToDuyDuc2001</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
							</div>
							<!--/ End Twitter Widget -->
						</div>
						<div class="col-lg-3 col-md-6 col-12">
							...
							<div class="single-widget newsletter" id="newsletter">
								...
								<form method="post" action="<?php echo _WEB_HOST_ROOT.'/submit-subcribe.html'; ?>">
									<?php getMsg($msg,$msg_type); ?>
									<input placeholder="Tên của bạn..." type="text" name="fullname">
									<?php echo form_errors('fullname',$errors,'<span class="errors">','</span>'); ?>
									<input placeholder="Email của bạn..." type="text" name="email">
