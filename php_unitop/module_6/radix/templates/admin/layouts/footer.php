...
<!-- sử dụng file thư viện jquery menu editor -->
<script src="<?php echo _WEB_HOST_ROOT_ADMIN_TEMPLATES;?>/assets/dist/js/jquery-menu-editor.min.js"></script>
<script src="<?php echo _WEB_HOST_ROOT_ADMIN_TEMPLATES;?>/assets/dist/js/bootstrap-iconpicker.min.js"></script>
<?php 
$body = getBody();
$module = null;
