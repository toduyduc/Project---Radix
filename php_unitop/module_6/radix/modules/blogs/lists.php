					...
					<div class="col-12">
						...
						<div class="pagination-main">
							<ul class="pagination">
                                ...
                                ?>
								<li class="<?php echo ($index==$page)?'active':false; ?>"><a href="<?php echo _WEB_HOST_ROOT.'/blog-page-'.$index.'.html';?>"><?php echo $index; ?></a></li>
								<?php 
                                } 
                                if($page<$maxPage){
                                    $lastPage = $page+1;
                                    echo '<li class="next"><a href="'._WEB_HOST_ROOT.'/blog-page-'.$lastPage.'.html"><i class="fa fa-angle-double-right"></i></a></li>';
                                }
                                ?>
