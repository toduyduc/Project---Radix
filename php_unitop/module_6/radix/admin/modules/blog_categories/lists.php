                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger btn-sm" style="padding: 0 5px;" href="<?php echo getLinkAdmin("blog_categories","duplicate",['id'=>$item['id']]); ?>"> Nhân bản</a> 
                                <?php endif; ?>
                                <a class="btn btn-success btn-sm" style="padding: 0 5px;" href="<?php echo getLinkModule('blog_categories',$item['id']); ?>" target="_blank"> Xem</a>
                            </td>
