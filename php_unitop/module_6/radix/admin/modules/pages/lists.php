            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-danger btn-sm" style="padding: 0 5px;" href="<?php echo getLinkAdmin("pages","duplicate",['id'=>$item['id']]); ?>"> Nhân bản</a>
                        <?php endif; ?>
                    </td>
                    <td><?php echo getDateFormat($item["create_at"],'d/m/Y H:m:s'); ?></td>
                    <td class="text-center"><a target="_blank" href="<?php echo getLinkModule('pages',$item['id']); ?>" class="btn btn-primary btn-sm">Xem</a></td>
                    <?php if($checkPermissionEdit): ?>
